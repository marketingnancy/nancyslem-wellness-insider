            ...
            <div className="flex items-center justify-between w-full md:w-auto gap-4">
              <div className="flex flex-col items-start md:items-end">
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded">BESPAAR € 46,00</span>
                </div>
                {showTimer && (
            ...
            <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <tbody className="text-sm">
                ...
                <tr className="bg-[#FFE14D]/20 font-bold">
                  ...
                  <td className="border border-gray-300 p-4 text-center text-[#FF1493]">€ 92,95 (eenmalig)</td>
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="space-y-1 text-gray-600">
                      ...
                      <li>✓ En in het slechtste geval krijg je je € 92,95 gewoon terug</li>
                    </ul>
                  </div>
                  <div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="border-4 border-[#FF1493] shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-red-500 text-white px-6 py-2 transform rotate-12 translate-x-8 -translate-y-2">
                <p className="font-bold">BESPAAR € 46</p>
              </div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-4 mb-4">
                    ...
                    <div className="text-left">
                      ...
                      <span className="text-sm text-green-600 font-bold">Bespaar € 46 (33% korting)</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-[#FF1493]/10 to-[#FFE14D]/10 p-4 rounded-lg mb-4">
                    <p className="text-center text-gray-900">
                      <strong className="text-2xl text-[#FF1493]">Slechts € 0,25 per dag</strong> bij een jaar gebruik
                    </p>
            ...
            <Card className="border-2 border-[#FF1493] bg-white hover:shadow-xl transition-shadow">
              <CardContent className="p-8 space-y-4">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <Heart className="w-5 h-5 text-[#FF1493] flex-shrink-0 mt-0.5" />
                    <span>Je bereid bent om <strong>in jezelf te investeren</strong> (slechts € 0,25 per dag over een jaar!)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Heart className="w-5 h-5 text-[#FF1493] flex-shrink-0 mt-0.5" />
